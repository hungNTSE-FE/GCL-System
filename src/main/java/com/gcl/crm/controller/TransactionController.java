...
public class TransactionController {
    ...
    public String showTransactionPerform(@PathVariable(name = "id") long id, Model model){
        ...
        List<TransactionHistory> transactionHistoryList = customer.getTransactionHisstories();
        if(customer.
                getContract().
                getTradingAccount().
            ...
            model.addAttribute("customer",customer);
            model.addAttribute("listTransactionHistories",transactionHistoryList);
            model.addAttribute("size",transactionHistoryList.size());
    ...
    public String transactionDeposit( RedirectAttributes ra, @ModelAttribute("tradingForm") TradingForm tradingForm, Model model ) throws ParseException {
        ...
        for(int i = 0 ;i<bankAccountList.size();i++){
            ...
            if(transactionHistory !=null){
                ...
                customer.setTransactionHisstories(list);
            }
